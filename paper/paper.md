...
Evaluation research has also evolved. Early visual question answering benchmarks such as VQA [@antol2015vqa], GQA [@hudson2019gqa], and OK-VQA [@marino2019okvqa] tested specific combinations of perception, language, compositional reasoning, and external knowledge. TextVQA and ChartQA extended evaluation toward visual text reading and chart reasoning [@singh2019textvqa] [@masry2022chartqa]. ScienceQA introduced science-question reasoning with multimodal explanations [@lu2022scienceqa]. Modern MLLM benchmarks such as MME, MMBench, MM-Vet, and MMMU attempt to measure broader capability dimensions [@fu2023mme] [@liu2023mmbench] [@yu2023mmvet] [@yue2023mmmu]. POPE focuses specifically on object hallucination [@li2023pope], while MathVista evaluates mathematical reasoning in visual contexts [@lu2023mathvista]. This benchmark expansion reflects a key point: no single test can characterize an MLLM.
